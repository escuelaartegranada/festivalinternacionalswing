  ...
  return (
    <section id="pases" className="py-20 bg-retro-yellow border-y-[16px] border-retro-navy px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <h2 className="font-rye text-4xl md:text-6xl text-retro-navy uppercase tracking-wider mb-4">Tickets & Full Passes</h2>
          <p className="font-sans font-bold text-xl text-retro-navy">Compra tu entrada y no te pierdas nada del festival.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {passes.map((pass, index) => (
            ...
            >
              ...
              <h3 className="font-deco text-2xl text-retro-red uppercase mb-4 pr-10">{pass.name}</h3>
