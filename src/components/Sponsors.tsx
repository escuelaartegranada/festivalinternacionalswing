  ...
  return (
    <section id="patrocinadores" className="py-16 bg-retro-cream border-t-[16px] border-retro-red px-4">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          <h2 className="font-deco text-3xl md:text-5xl text-retro-navy uppercase tracking-wider mb-4">{t('nav.patrocinadores')}</h2>
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-70 hover:opacity-100 transition-opacity">
          {sponsors.map((sponsor, index) => (
            ...
            >
              <span className="font-sans text-xs font-bold text-retro-red tracking-widest uppercase mb-2">{t(`data.sponsorsRole.${sponsor.name}`, { defaultValue: sponsor.role })}</span>
